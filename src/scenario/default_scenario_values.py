...
class ScenarioContent:
    ...
    image: DefaultImage = field(default_factory=DefaultImage) 
    time: DefaultTime = field(default_factory= DefaultTime)
    trajectory: DefaultTrajectory =  field(default_factory=DefaultTrajectory)
