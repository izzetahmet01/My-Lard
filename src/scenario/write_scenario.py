...
def write_scenario(scenario_config: Union[pathlib.Path, ScenarioConfig]) -> None:
    ...
    if scenario_content.image.watermark_height is not None:
        ...
        print("scenario_content.image.height : ",scenario_content.image.height)
        print("2 * scenario_content.image.watermark_height : ", 2 * scenario_content.image.watermark_height)
        print("height : ",height )
