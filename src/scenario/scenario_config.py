...
class ScenarioConfig:
    def __init__(self, airport=None, runway=None, scenario_dir=None, yaml_file=None,file_name = None):
        """
        ...
        """
        self.content = ScenarioContent(airport=airport, runways=runway,file_name = file_name)
