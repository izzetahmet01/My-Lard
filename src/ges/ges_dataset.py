...
def define_offset(
    ...
    # ap_lat, ap_long = 48.96930161320801, 2.4405372083784647
    ...
    psi_deg = np.random.normal(traj.yaw_deg , traj.std_yaw_deg, (traj.sample_number,))
